...
void counttruth::Loop()
{
	...
	//variable binning
	const char* fitfilename="../forroofit/March09/150309counttruth.root";
...
//TODO calculate purities per bin,store them in array an plot them with TGraphErrors
	...
	TLegend* leg = new TLegend(0.6,0.7,0.7,0.8);
	 ...
	 grnEB->Draw("SAME P");
	 leg->Draw();
	 grEB->SaveAs("../plots/March09/grEB.root");
	 grnEB->Save("../plots/March09/grnEB.root");
 	 c1->Print("../plots/March09/150309_purity_counting.root","root");
	 c1->Print("../plots/March09/150309_purity_counting.png","png");
